...
namespace DigitalRune.Windows.TextEditor
{
  ...
  public class ToolTipRequestEventArgs : EventArgs
  {
    ...
    /// </summary>
    /// <value><c>true</c> if the mouse cursor is over document; otherwise, <c>false</c>.</value>
    ...
    /// <param name="inDocument">if set to <c>true</c> mouse cursor is over the document.</param>
