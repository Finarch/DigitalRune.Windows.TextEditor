...
namespace DigitalRune.Windows.TextEditor
{
  public partial class TextEditorControl
  {
    ...
    /// </summary>
    /// <value>
    /// 	<c>true</c> if the completion window is shown; otherwise, <c>false</c>.
    /// </value>
    [Browsable(false)]
    ...
    /// <summary>
    /// Gets the completion window
    /// </summary>
    public CompletionWindow CompletionWindow
    {
      get { return CompletionWindowVisible ? completionWindow : null; }
    }
    ...
    /// <param name="usePreselection">Whether to look backward from the caret for a preselection</param>
