...
namespace DigitalRune.Windows.TextEditor.Completion
{
  ...
  public abstract class AbstractCompletionDataProvider : ICompletionDataProvider
  {
    ...
    /// <returns>
    /// 	<c>true</c> if <paramref name="key"/> shall commit the completion; otherwise, <c>false</c>.
    /// </returns>
    ...
    /// <param name="key">The key.</param>
    /// <returns>
    /// Returns <c>true</c> when the insert action has processed the character
    /// <paramref name="key"/>; <c>false</c> when the character was not processed.
    /// </returns>
    /// <remarks>
