      ...
      while (!_caretCreated)
      {
        switch (_caretMode)
        {
          case CaretMode.InsertMode:
            _caretCreated = CreateCaret(_textArea.Handle, 0, 2, _textArea.TextView.FontHeight);
            break;
          case CaretMode.OverwriteMode:
            _caretCreated = CreateCaret(_textArea.Handle, 0, _textArea.TextView.SpaceWidth, _textArea.TextView.FontHeight);
            break;
        }
      }
      if (_currentPos.X < 0)
