...
namespace DigitalRune.Windows.TextEditor.Bookmarks
{
  ...
  public class Bookmark
  {
    ...
    /// </summary>
    /// <value>The anchor used for this bookmark. <c>null</c> if the bookmark is not connected to a document.</value>
    ...
    /// <param name="document">The document.</param>
    /// <param name="location">The location of the bookmark.</param>
    /// <param name="enabled">If set to <c>true</c> this bookmark is enabled.</param>
