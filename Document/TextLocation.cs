...
namespace DigitalRune.Windows.TextEditor.Document
{
  ...
  public struct TextLocation : IComparable<TextLocation>, IEquatable<TextLocation>
  {
    ...
    /// <returns><c>true</c> if the specified <see cref="TextLocation"/> is equal to the current <see cref="TextLocation"/>; otherwise, <c>false</c>.</returns>
    ...
    /// <returns><c>true</c> if the specified <see cref="TextLocation"/>s are equal; otherwise, <c>false</c>.</returns>
    ...
    /// <param name="a">The first <see cref="TextLocation"/>.</param>
    /// <param name="b">The second <see cref="TextLocation"/>.</param>
    /// <returns><c>true</c> if the specified <see cref="TextLocation"/>s are not equal; otherwise, <c>false</c>.</returns>
    public static bool operator !=(TextLocation a, TextLocation b)
    {
      return (a._x != b._x) || (a._y != b._y);
    }
    ...
    /// <param name="a">The first <see cref="TextLocation"/>.</param>
    /// <param name="b">The second <see cref="TextLocation"/>.</param>
    /// <returns><c>true</c> if the <paramref name="a"/> lies before <paramref name="b"/>; otherwise, <c>false</c>.</returns>
    public static bool operator <(TextLocation a, TextLocation b)
    {
      if (a._y < b._y)
        return true;
    ...
    /// <param name="a">The first <see cref="TextLocation"/>.</param>
    /// <param name="b">The second <see cref="TextLocation"/>.</param>
    /// <returns><c>true</c> if the <paramref name="a"/> lies after <paramref name="b"/>; otherwise, <c>false</c>.</returns>
    public static bool operator >(TextLocation a, TextLocation b)
    {
      if (a._y > b._y)
        return true;
    ...
    /// <param name="a">The first <see cref="TextLocation"/>.</param>
    /// <param name="b">The second <see cref="TextLocation"/>.</param>
    /// <returns><c>true</c> if the <paramref name="a"/> lies before or at the same location as <paramref name="b"/>; otherwise, <c>false</c>.</returns>
    public static bool operator <=(TextLocation a, TextLocation b)
    {
      return !(a > b);
    }
    ...
    /// <param name="a">The first <see cref="TextLocation"/>.</param>
    /// <param name="b">The second <see cref="TextLocation"/>.</param>
    /// <returns><c>true</c> if the <paramref name="a"/> lies after or at the same location as <paramref name="b"/>; otherwise, <c>false</c>.</returns>
    public static bool operator >=(TextLocation a, TextLocation b)
    {
      return !(a < b);
    }
