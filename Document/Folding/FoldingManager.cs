...
namespace DigitalRune.Windows.TextEditor.Folding
{
  ...
  public class FoldingManager
  {
    ...
    /// <param name="lineNumber">The line number.</param>
    /// <returns>
    /// 	<c>true</c> if any folds start at <paramref name="lineNumber"/>; otherwise, <c>false</c>.
    /// </returns>
    ...
    /// <param name="lineNumber">The line number.</param>
    /// <returns>
    /// 	<c>true</c> if any folds end at <paramref name="lineNumber"/>; otherwise, <c>false</c>.
    /// </returns>
    ...
    /// <param name="lineNumber">The line number.</param>
    /// <returns>
    /// 	<c>true</c> if <paramref name="lineNumber"/> belongs to a fold; otherwise, <c>false</c>.
    /// </returns>
