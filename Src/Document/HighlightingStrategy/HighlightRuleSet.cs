...
namespace DigitalRune.Windows.TextEditor.Highlighting
{
  ...
  public class HighlightRuleSet
  {
    ...
    /// </summary>
    /// <value><c>true</c> if case-insensitive; <c>false</c> if case-sensitive.</value>
    ...
    /// </summary>
    /// <value>
    /// 	<c>true</c> if digits in the span are highlighted; otherwise, <c>false</c>.
    /// </value>
