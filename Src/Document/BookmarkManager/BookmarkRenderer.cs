...
namespace DigitalRune.Windows.TextEditor.Bookmarks
{
  ...
  public static class BookmarkRenderer
  {
    ...
    /// <summary>
    /// Draws a bookmark icon in the margin.
    /// </summary>
    /// <param name="g">The <see cref="Graphics"/> context.</param>
    /// <param name="rectangle">The bounding rectangle.</param>
    /// <param name="isEnabled"><c>true</c> if enabled..</param>
    public static void DrawBookmark(Graphics g, Rectangle rectangle, bool isEnabled)
    {
    ...
    /// <summary>
    /// Draws an arrow icon in the margin.
    /// </summary>
    /// <param name="g">The <see cref="Graphics"/> context.</param>
    /// <param name="rectangle">The bounding rectangle.</param>
